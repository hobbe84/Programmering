...
namespace Lonerevision_A
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.Clear();
                antalLoner = LasUint("Ange antal löner att mata in: ");
        ...
        static uint LasUint(string prompt)
        {
            ...
            while (true) // Felhantering på input ifall du anger en sträng ist för ett heltal
            {
                try
                {
                    ...
                    talHantering = uint.Parse(braNummer);
                    break;
                }
                catch (Exception)
                {
        ...
        static void HanteraLoner(uint antalLoner)
        {
            uint[] loner = new uint[antalLoner];
            Console.WriteLine();
